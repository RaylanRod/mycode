...
for hero_info in classinfo['all']:
    if hero_info['name'] == 'Raylan':
        name = hero_info['name']
        spirit_animal = hero_info['spirit animal']
        skills = hero_info['skill level']
        super_power = hero_info['super power']
...
for every_person in classinfo['all']:
    name = hero_info['name']
